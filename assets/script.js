...
// initialize array to hold High Scores listings: objects containing initials and scores which will be loaded from localStorage
...
// displays score ranking on High Scores screen
...
// Click listeners on High Scores buttons

// Clear the High Scores listing of all scores button
...
// Event listener on High Scores link at top of page to display the High Scores screen
hofLink.addEventListener("click", function () {
    // clear timer if there is one
    clearInterval(timerInterval);
    // render the High Scores score listing on the screen
    renderScores();
})
